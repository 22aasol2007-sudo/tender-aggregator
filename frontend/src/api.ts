...
export const TRANSPORT_FULL_Q_FALLBACK =
  "49.41, 49.4, 52.29, 52.21, рефрижератор, рефтранспорт, хладотранспорт, изотерм, изотермическ, температурный режим, температурн, скоропортящ, холодовая цепь, холодная цепь, охлаждённ, охлажденн, замороженн, рефрижераторн, reefer, грузоперевоз, грузоперевозк, перевозка грузов, перевозки грузов, перевозку грузов, перевозкам грузов, автоперевоз, автоперевозк, доставка грузов, доставке грузов, доставки грузов, транспортные услуги, транспортных услуг, оказание транспортных услуг, транспортно-экспедиц, транспортно экспедиц, экспедирован, экспедиторск, экспедиционн, фрахт, логистическ, логистик, автотранспортн, грузовым автомобил, автомобильным транспортом, услуги грузового транспорта, грузового автотранспорт, перевозка продукции, перевозки продукции, перевозка товаров, перевозки товаров, услуги по перевозке, оказание услуг по перевозке, услуги перевозки, контейнерные перевоз, контейнерных перевоз, тентованн, негабаритн, сборных грузов, сборный груз, фура, еврофура, трал";
