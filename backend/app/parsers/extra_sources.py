...
class TekTorgParser(CommercialHtmlParser):
    def __init__(self) -> None:
        ...
        self.search_urls = ["https://www.tektorg.ru/", "https://www.tektorg.ru/procedures"]
...
class OtcParser(CommercialHtmlParser):
    def __init__(self) -> None:
        ...
        self.search_urls = ["https://www.otc.ru/", "https://tender.otc.ru/"]
...
class AgzrtParser(CommercialHtmlParser):
    def __init__(self) -> None:
        ...
        self.search_urls = ["https://agzrt.ru/", "https://zakupki.tatarstan.ru/"]
...
class KartotekaParser(CommercialHtmlParser):
    def __init__(self) -> None:
        ...
        self.search_urls = ["https://www.kartoteka.ru/", "https://www.kartoteka.ru/bankruptcy/"]


class ApiBackedParser(CommercialHtmlParser):
    """HTML + optional JSON API with token from settings."""
